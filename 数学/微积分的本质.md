...
[![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180625205043.png)](http://www.codecogs.com/eqnedit.php?latex=\int_{a}^{b}f(x)dx)
...
![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180626114634.png)

把车速的图像加入其中，可以发现：两者存在着某种联系：其中之一改变的话，也会引起另一个发生变化。

![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180626111415.png)
![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180626112123.png)
...
- 记时间差为 `dt`，距离差为 `ds`，那么这段时间内的速度就能用 `ds/dt` 表示
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180626111112.png)
...
- 在纯数学领域，**导数**不是 `dt` 为某个具体值时 `ds/dt` 的值 ，而是当 `dt` 的值**无限逼近 0 时**这个比值的**极限**。
    ...
    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180627210310.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{ds(t)}{dt}=\underbrace{\frac{s(t&plus;dt)-s(t)}{dt}}_{dt\rightarrow&space;0}&space;\end{aligned})
...
- 上一节给出了 `f(x) = x^3` 导数的代数推导过程，这里也可以作为立方体体积来用几何的方式推导。
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180626213324.png)

**负的变化量**
- 上述两个例子的变化量都是增量（正值），但实际上**变化量也可能是负值**，比如 `f(x) = 1/x`——考虑这样一个特殊的矩形，长 `x`，宽 `1/x`，它的面积恒为 1.

    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180626221601.png)
    > 注意：这里的变化量不再是矩形的面积了，而是**矩形的高**

- 通过简单的几何知识，可知矩形**高**的变化量为：

    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180626223957.png)](http://www.codecogs.com/eqnedit.php?latex=d(\frac{1}{x})=-(\frac{1}{x}-\frac{1}{x&plus;dx}))

- 从而得到 `1/x` 的导数为：

    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180626224325.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;&&space;d(\frac{1}{x})=\frac{-dx}{x^2&plus;xdx}&space;\\&space;\Rightarrow&space;&&space;\frac{d(\frac{1}{x})}{dx}=\frac{-1}{x^2&plus;xdx}=-\frac{1}{x^2}&space;\end{aligned})
    
**幂函数的导数**
- 以上 `x^2`、`x^3` 和 `x^-1` 都遵循了幂函数的求导公式：

    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180626213915.png)](http://www.codecogs.com/eqnedit.php?latex=\frac{d(x^n)}{dx}=nx^{n-1})
    
- 思考一下为什么这个公式也适用于 2 和 3 以外的指数——求导的一个关键点在于很大一部分项因为包含 `dx` 的高次幂，可以被忽略——因此有

    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180626214855.png)
...
- 正弦函数的定义
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627100028.png)
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627103330.png)
...
- `sin(θ)` 当 `θ` 增加时的微小变化量
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627104200.png)
    - 在近似的观点下，应该有这样的直觉——可以把那一段微小的圆弧`dθ`看作是直线

- 根据三角函数的定义，有

    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180627104751.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;&d(\sin\theta)=\cos\theta\,d\theta\\\Rightarrow&space;&\frac{d(\sin\theta)}{d\theta}=\cos\theta&space;\end{aligned})
...
[![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180627113753.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;&d(g(x)&plus;h(x))=\frac{dg}{dx}&plus;\frac{dh}{dx}\\&space;\end{aligned})

![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627111545.png)
> 加法法则比较简单，可以在坐标轴中展示
...
[![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180627154921.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{d}{dx}(g(x)h(x))=h(x)\frac{d\,g(x)}{dx}&plus;g(x)\frac{d\,h(x)}{dx}&space;\end{aligned})

![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627114343.png)
...
[![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180627160852.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{d}{dx}g(h(x))=\frac{dg(h(x))}{dh(x)}\frac{dh(x)}{dx}=\frac{dg}{dh}\frac{dh}{dx}&space;\end{aligned})

![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627155759.png)
![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627155845.png)

![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627155928.png)
![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627160125.png)
> 链式法则的表达式在说：看看输出值 g 的微小变化除以 h 的微小变化是多少（h 是要带入函数 g 中的值）；然后乘以 h 微小变化与 x 微小变化的比值

![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627161532.png)
...
- 根据导数的定义，有
    ...
    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180627205326.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{d2^t}{dt}&space;&=\frac{2^{t&plus;dt}-2^t}{dt}\\&space;&=\frac{2^t2^{dt}-2^t}{dt}\\&space;&=2^t\cdot\frac{2^{dt}-1}{dt}\\&space;&=2^t\cdot&space;h&space;\end{aligned})

- 当 `dt → 0` 时，`h` 趋向于一个常数 `0.6931...`
- 也就是说，`2^t` 图像上各点处**切线的斜率 = 该点的函数值 * 一个常数**

    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627210731.png)
...
- 不要问为什么当 `e^t` 时，`h=1`；因为 `e` 就是如此定义的。
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627212338.png)
...
- 根据指数函数的性质与链式法则，有
    ...
    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180627213245.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{d(c^t)}{dt}&space;&=\frac{d(e^{\ln(c)t})}{dt}\\&space;&=\ln(c)e^{\ln(c)t}=\ln(c)c^t&space;\end{aligned})
...
- 比如：在室温环境下，热水变凉的速率与水和房间的温差成正比（或者说，温差的变化率与温差本身成正比）
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180627213951.png)
...
- 圆的方程就是一个隐函数，比如 `x^2 + y^2 = 5^2`，下面需要求圆上一点的斜率（不考虑几何方法）
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180628104522.png)

- 因为这里的曲线并不是一个函数图像，所以不能单纯对其求导——它不存在变量 x 的微小变化对函数值 y 的微小变化
- 当然，如果我们的目标只是求 `dy/dx`，那么对等式两边同时求导可以解决：

    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180628110309.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;&d(x^2&plus;y^2)=d(5^2)\\\Rightarrow&space;&2xdx&plus;2ydy=0\\\Rightarrow&space;&\frac{dy}{dx}=\frac{-x}{y}&space;\end{aligned})
...
- 其实**隐函数的导数也是一个隐函数**，它对 `dx` 和 `dy` 的关系做了限制——在圆的例子上，它要求整体变化量 `dS = 2xdx + 2ydy` 为 0；也就是说为了让 `S = x^2 + y^2` 始终保持在 25，那么 `dS` 就需要为 0.
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180628120153.png)
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180628120634.png)
...
- 该函数的图像是一系列 U 型曲线
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180628121250.png)
...
- 根据指数函数与对数函数的关系，有
    ...
    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180628141926.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;&y=\ln(x)\\\Rightarrow&space;&e^y=x\\\Rightarrow&space;&e^ydy=dx\\\Rightarrow&space;&\frac{dy}{dx}=\frac{1}{e^y}=\frac{1}{e^{\ln(x)}}=\frac{1}{x}\\\Rightarrow&space;&\frac{d\ln(x)}{dx}=\frac{1}{x}&space;\end{aligned})
...
- 在[[2.2. 导数的定义与计算](#22-导数的定义与计算)]已经给出了导数的计算公式：
    ...
    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180628143525.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{df(x)}{dx}=\underbrace{\frac{f(x&plus;dx)-f(x)}{dx}}_{dx\rightarrow&space;0}&space;\end{aligned})

    导数的正式定义：

    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180628144611.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{df(x)}{dx}=\lim_{\Delta&space;x&space;\to&space;0}\frac{f(x&plus;\Delta&space;x)-f(x)}{\Delta&space;x}&space;\end{aligned})
    
    或

    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180628144731.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\frac{df(x)}{dx}=\lim_{h&space;\to&space;0}\frac{f(x&plus;h)-f(x)}{h}&space;\end{aligned})
...
>
> [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180628200345.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\lim_{x&space;\to&space;x_0}f(x)=a&space;\end{aligned})

**极限存在与不存在的两个例子**

![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180628201027.png)
![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180628201344.png)
...
![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180628203925.png)
...
- 洛必达法则利用了这样一个性质——当`f(a)=0`时，在`a`的附近，有`f(a+dx)=f'(a+dx)`。如图所示：
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180628211047.png)
    > 当 `dx` 越小，这个比值就越精确

- 洛必达法则：

    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180628210652.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\lim_{x&space;\to&space;a}\frac{f(x)}{g(x)}=\lim_{x&space;\to&space;a}\frac{f%27(x)}{g%27(x)}=A&space;\end{aligned})
    > 条件：1）`f(x)`和`g(x)`在点`a`处的极限都为 0；2）`f(x)`和`g(x)`在点`a`的某去心领域内可导，且`g'(x)!=0`；3）`A`可以为实数，也可以为`±∞`
    >
    > 注意，只要满足以上条件，洛必达法则是可以继续进行的

    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180628211807.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\lim_{x&space;\to&space;a}\frac{f(x)}{g(x)}=\lim_{x&space;\to&space;a}\frac{f%27(x)}{g%27(x)}=\lim_{x&space;\to&space;a}\frac{f%27%27(x)}{g%27%27(x)}=...&space;\end{aligned})
...
![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180629094906.png)
...
- 从数学的角度，前者的问题等价于求“`s(t)`的导数”，于是现在的问题也就是求“哪个函数的导数是`v(t)`”——这通常被称为“求函数的‘**原函数**’（或‘反导数’）”
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180629100103.png)

- 类比[[1.1. 节](#11-推导圆的面积---积分的直观理解)]中推导圆面积的公式，这个问题可以转化成求解曲线下方的面积

    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180629101348.png)
...
- 这表明任一**函数图像下方面积函数的导函数等于该函数本身**
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180629150107.png)
...
- 因此，求解积分的过程就是求导的**逆过程**
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180629150441.png)
...
- 所以`v(t) = 8t - t^2`正确的原函数应该是
    ...
    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180629153014.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;s(t)=\int&space;v(t)dt=4t^2-\frac{1}{3}t^3&plus;C&space;\end{aligned})
...
- 这个过程就是“微积分基本定理”
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180629153515.png)
...
- 如果图像有部分出现在横轴的下方，那么这部分就是**负面积**
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180629160418.png)
    > 有符号的面积
...
- 如果把面积作为一个整体来看，这是一个很简单的问题——`平均高度 = 积分面积 / 上下限宽度`
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180629193011.png)
...
- 根据导数的定义，二阶导数也就是导数的微小变化率，即斜率的变化率——直观来看，也就是**曲线的弯曲程度**
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180629210933.png)
...
- 用符号表示为
    ...
    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180629211135.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;\underbrace{\frac{d(\frac{df}{dx})}{dx}=\frac{d(df)}{(dx)^2}=\frac{d^2f}{dx^2}}_{dx&space;\to&space;0}&space;\end{aligned})
...
- `x=0` 时，它的常数项能让它与 `f(0)` 的值相等
    ...
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180630153013.png)

- 它的一次项让两者的斜率相等

    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180630153808.png)

- 二次项让两者斜率的变化率相同

    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180630153907.png)
    
- 以此类推，项数越多，近似就越精确

    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180630154029.png)
    
    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180630154212.png)

**从几何角度看二阶泰勒多项式**
- 考虑如何近似曲线下的面积函数 `f_area(x)`

    ![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/TIM截图20180630194836.png)
...
- 函数`f(x)`在`x=0`处的泰勒多项式
    ...
    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180630152255.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;P(x)=f(0)&plus;\frac{f%27(0)}{1!}x&plus;\frac{f%27%27(0)}{2!}x^2&plus;\frac{f^{(3)}(0)}{3!}x^3&plus;\cdots&space;\end{aligned})

- 函数`f(x)`在`x=a`处的泰勒多项式

    [![](https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/raw/master/_assets/公式_20180630152454.png)](http://www.codecogs.com/eqnedit.php?latex=\begin{aligned}&space;P(x)=f(a)&plus;\frac{f%27(a)}{1!}(x-a)&plus;\frac{f%27%27(a)}{2!}(x-a)^2&plus;\frac{f^{(3)}(a)}{3!}(x-a)^3&plus;\cdots&space;\end{aligned})
