...
**示例：一个用于数字手写识别的神经网络**
https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/blob/master/_assets/LSTM3-focus-C.png?raw=true
